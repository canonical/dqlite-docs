...
formats to code tuples, depending on the kind of message. They are described in detail below, and the differences between them are summarized by this table:
...
These properties can be used to inform how leaders manage node roles within the cluster to maximize availability.
